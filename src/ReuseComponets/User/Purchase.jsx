...
const ProductDetail = () => {
        ...
        <div className="flex flex-col md:flex-row gap-8">
          <div className="flex-1">
            ...
            <div className="flex gap-2 mt-4 overflow-x-auto">
              {[...Array(4)].map((_, index) => (
                <Skeleton key={index} className="w-20 h-24 rounded flex-shrink-0" />
              ))}
            </div>
          </div>
    ...
    return (
      <div className="container mx-auto px-4 py-8 text-center">
        ...
        <p className="text-gray-600">
          The requested product could not be found. It may have been removed or
          doesn't exist.
        </p>
      </div>
    );
  ...
  const { name, price, offerPrice, images, sizes, description, category, offer } =
    productData;
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="lg:w-1/2 space-y-6">
            ...
            <div className="flex items-center space-x-2">
              ...
              {price !== offerPrice && (
                <p className="text-sm font-thin line-through text-gray-500">
                  ₹{price}
                </p>
              )}
            </div>
